...
<table id="monPointGrid" 
    ...
    data-options="rownumbers:true,singleSelect:true, idField: 'id',url:'alarm/alarmcolor/data',toolbar:config.threshold.toolbar,pagination:'true',fitColumns:true,fit:true">
  <thead>
    <tr>
